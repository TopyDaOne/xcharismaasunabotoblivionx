...
╚═╝╚══╝╚═╝╚══╝─╚═╝─╚══╝╚═╝╚╩═╝
        **Prefix is "!!"**
        ...
        ❄️ ***__General Commands__***❄️ 
**
id , embed , say , server , animal , image , avatar , dt 
roll , members .
...
**
        ...
        🤖***__Bot Commands__***🤖
**
ping , support , invite , bot , uptime .

**

       🚫 ***__Administrative Commands__***🚫
**
kick , ban , mute , unmute , mutechannel , unmutechannel , delet[room name ] , ct [createTextchannel] , cv [createVoicechannel ] ,
bc , v2min .
...
**
       ...
       🎶***__Music Commands__***🎶
 play, vol , np , skip , skip , queue , pause , resume .

**

       🕋***__Islamic Commands__***🕋
 **       
!!h-q <<<<<< To see the commands of quran 
!!اذكار
...
**
        ...
        🕹️***__Games orders__***🕹️
 **       
صراحه , مريم , خواطر , حب , عقاب , كت تويت , hack
...
var stats = new Fortnite(process.env.TRN);
...
if (!args[1]) return message.channel.send ('**	Please Include the platform: !fortnite platform username`**');
platform = args.shift();
username = args.join(' ');
stats.getInfo(username, platform).then(data => {
	...
	.setDescription(`**Top Placement**\n\n**Top 3s:** *${data.lifetimeStats[0].value}*/n**Top 5s:**
